...
class StagedItemsController < ApplicationController
  ...
  def create
    ...
    redirect_to staged_items_path, flash: message
  end
  ...
  def add_with_item
    ...
    packed_item = item.packed_items
      .build(packed_item_params.merge(status: PackedItem::STAGED))
